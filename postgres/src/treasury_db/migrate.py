#!/usr/bin/env python3
"""Apply the SQL migrations in postgres/migrations to the target database.
...
Usage::
    ...
    python -m treasury_db.migrate            # apply everything pending
    python -m treasury_db.migrate --status   # show what is applied
...
from treasury_db.db import REPO_ROOT, connect, describe_target, fetch_all

LOGGER = logging.getLogger("us_treasury.migrate")

from treasury_db.paths import MIGRATIONS_DIR
