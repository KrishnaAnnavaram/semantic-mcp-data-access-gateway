...
Streamlit chatbot front-end for the smart MCP project. Sends a user's question to the smart
...
responses — no other services required. Once the smart agent is available, set in `.env`:
...
LANGCHAIN_PROJECT=smart-mcp-chatbot
```
